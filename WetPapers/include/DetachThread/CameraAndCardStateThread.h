...
class CameraAndCardStateThreadWetPapers : public QThread
{
	Q_OBJECT
private:
...
public:
	explicit CameraAndCardStateThreadWetPapers(QObject* parent = nullptr);

	~CameraAndCardStateThreadWetPapers() override;
