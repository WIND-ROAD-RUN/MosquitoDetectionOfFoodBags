...
namespace cdm {
    class WetPapersConfig
    {
    public:
        WetPapersConfig() = default;
        ~WetPapersConfig() = default;

        WetPapersConfig(const rw::oso::ObjectStoreAssembly& assembly);
        WetPapersConfig(const WetPapersConfig& obj);

        WetPapersConfig& operator=(const WetPapersConfig& obj);
        operator rw::oso::ObjectStoreAssembly() const;
        bool operator==(const WetPapersConfig& obj) const;
        bool operator!=(const WetPapersConfig& obj) const;
    ...
    inline WetPapersConfig::WetPapersConfig(const rw::oso::ObjectStoreAssembly& assembly)
    {
        auto isAccountAssembly = assembly.getName();
        if (isAccountAssembly != "$class$WetPapersConfig$")
        {
            throw std::runtime_error("Assembly is not $class$WetPapersConfig$");
        }
    ...
    inline WetPapersConfig::WetPapersConfig(const WetPapersConfig& obj)
    {
    ...
    inline WetPapersConfig& WetPapersConfig::operator=(const WetPapersConfig& obj)
    {
        if (this != &obj) {
            totalProductionVolume = obj.totalProductionVolume;
            totalDefectiveVolume = obj.totalDefectiveVolume;
    ...
    inline WetPapersConfig::operator rw::oso::ObjectStoreAssembly() const
    {
        rw::oso::ObjectStoreAssembly assembly;
        assembly.setName("$class$WetPapersConfig$");
    ...
    inline bool WetPapersConfig::operator==(const WetPapersConfig& obj) const
    {
